...
function testChop(){
  Logger.log(create("1234567890").chop(3));
  var stringEx = create("𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁𡈁");
  if(stringEx.toString() !== stringEx.chop(1).join("")) throw new Error();
  if(stringEx.toString() !== stringEx.chop(2).join("")) throw new Error();
  if(stringEx.toString() !== stringEx.chop(3).join("")) throw new Error();
  if(stringEx.toString() !== stringEx.chop(4).join("")) throw new Error();
  if(stringEx.toString() !== stringEx.chop(5).join("")) throw new Error();
