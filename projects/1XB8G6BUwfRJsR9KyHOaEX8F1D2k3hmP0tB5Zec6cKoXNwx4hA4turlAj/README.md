# Project: Html Template Library

## Overview

This Google Apps Script project, "Html Template Library," is a library for creating web apps with a tabbed user interface. It uses Bootstrap for styling and provides a set of functions to easily add different types of content as tabs.
...
- **ID:** `AKfycbw1Eqea8v8ILJy01ro2wmLZsrvtvnHRlTRIDtJZjw`
